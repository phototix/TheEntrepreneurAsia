...
<a href="?page=<?=$page?>&cate=<?=$cate?>&action=extralocation&id=<?=$id?>">
	<button type="button" class="btn btn-default" ><i class="fa fa-pencil"></i> Location</button>
</a>
...
<div class="widget-body">
	...
	<form action="#" class="form-horizontal" method="post" data-parsley-validate>
		...
		<textarea class="input-block-level" id="FCKeditor1" name="txtContent" rows="18"><?=getDataTable("db_blog_post", "post_id", $id, "extralocation")?></textarea>
