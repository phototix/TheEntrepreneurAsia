...
<table id="loadPostComments-table" data-plugin="DataTable" class="table table-striped" cellspacing="0" width="100%">
	...
	<tbody>
		...
		$result=getTable("db_annoucement_post_comments", "WHERE comment_stat<>'3' AND reply_id=0 AND blog_id='".$id."'");
		...
		<tr>
			...
			<?php
			$result2=getTable("db_annoucement_post_comments", "WHERE comment_stat<>'3' AND reply_id='".$row["comment_id"]."'");
