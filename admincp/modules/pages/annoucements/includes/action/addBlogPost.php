<a href="?page=<?=$page?>&cate=<?=$cate?>">
	<button type="button" class="btn btn-default" ><i class="fa fa-arrow-left"></i> Back to Announcement List</button>
</a>
<br><br>
...
<header class="widget-header">
	...
	<h4 class="widget-title">Create New Announcement</h4>
...
<div class="widget-body">
	...
	<form action="#" class="form-horizontal" method="post" data-parsley-validate>
		...
		<input type="hidden" name="form" value="pages-announcement-addPost">
