...
<h3 class="m-b-lg">Manage Gallery for Announcement: #<?=$id?> - <?=getPost($id, "post_title")?></h3>
...
<div class="table-responsive">
	...
	<table id="default-datatable" data-plugin="DataTable" class="table table-striped" cellspacing="0" width="100%">
		...
		<tbody>
          ...
          <td>
            <form method="post">
            <input type="hidden" name="form" value="pages-announcement-sortImage">
...
<input type="hidden" name="form" value="pages-announcement-deleteImage">
        ...
        <div class="widget-body">
          <div class="row">
            <form action="" id="uploadImageGallery" class="form-horizontal" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="form" value="pages-announcement-uploadImageGallery">
