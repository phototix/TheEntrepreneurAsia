...
<a href="?page=<?=$page?>&cate=<?=$cate?>&action=editBlogPost&id=<?=$id?>">
  <button type="button" class="btn btn-warning" ><i class="fa fa-pencil"></i> Edit Announcement Post</button>
</a>
...
<div class="widget-body">
  ...
  <form action="#" class="form-horizontal" method="post" data-parsley-validate>
    ...
    <input type="hidden" name="form" value="pages-announcement-updateBlogExtra">
    <input type="hidden" name="token" value="<?=$Token?>">

    <div class="form-group">
      <label for="control-demo-1" class="col-sm-2">Extra Option Title</label>
      <div class="col-sm-10">
        <input type="text" name="txtTitle" id="txtTitle" class="form-control" value="<?=getDataTable("db_annoucement_post", "post_id", $id, "extra_title")?>">
      </div>
    </div><!-- .form-group -->
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" name="txtURL" id="control-demo-1" placeholder="Extra option link to eg: URL" class="form-control" value="<?=getDataTable("db_annoucement_post", "post_id", $id, "extra_link")?>">
      </div>
    </div><!-- .form-group -->
    ...
    <textarea class="input-block-level" id="FCKeditor1" name="txtContent" rows="18"><?=getDataTable("db_annoucement_post", "post_id", $id, "extra_desc")?></textarea>
