...
<ul class="nav nav-tabs" role="tablist">
	...
	<li role="presentation"><a href="#enquiries" aria-controls="outlined" role="tab" data-toggle="tab">Enquiries</a></li>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
						<?php include("includes/tab_enquiries.php") ?>
					</div><!-- .widget-body -->
